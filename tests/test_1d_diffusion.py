...
class TestDiffusion1D_fs(TestDiffusion1DBase):
    ...
    def test_np(self):
        ...
        self.assertTrue(self.PDE.u_err     < 1.36E-05)
        self.assertTrue(self.PDE.ud_err[0] < 6.56E-06)
        self.assertTrue(self.PDE.en_err    < 1.36E-05)
...
class TestDiffusion1D_fd(TestDiffusion1DBase):
    ...
    def test_tt(self):
        ...
        self.assertTrue(self.PDE.u_err     < 1.36E-05)
        self.assertTrue(self.PDE.ud_err[0] < 6.76E-06)  # TODO! Why is so?
        self.assertTrue(self.PDE.en_err    < 1.26E-05)  # TODO! Why is so?
